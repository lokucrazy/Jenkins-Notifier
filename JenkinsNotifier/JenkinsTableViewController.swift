...
class JenkinsTableViewController: UITableViewController {
    var jenkinsProjectList = [String]()
    override func viewDidLoad() {
        super.viewDidLoad()
        jenkinsProjectList.append("jenkins name")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = jenkinsProjectList[indexPath.row]
        cell.detailTextLabel?.text = "jenkins detail"
        return cell
    }
